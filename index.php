...
if (!file_exists(__DIR__ . "/data/installed.lock")) {
    ...
    // CMS is installed but install directory still exists — this is a security risk.
    // The installer will refuse to run due to installed.lock, but the
    // directory should be deleted manually for best security practice.
}
