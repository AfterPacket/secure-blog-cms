...
if ($isAdmin) {
    ...
    foreach ($allPosts as $__p) {
        $pendingCommentsCount += $commentsManager->getCommentCountForPost($__p["id"], "pending");
    }
}
        ...
        <div class="container">
            ...
            <div class="admin-nav">
                ...
                <?php if ($isAdmin): ?>
                    ...
                    <a href="comments.php">💬 Comments<?php if ($pendingCommentsCount > 0): ?><span class="nav-badge"><?php echo number_format($pendingCommentsCount); ?></span><?php endif; ?></a>
                            ...
                            <?php foreach ($allPosts as $post): ?>
                                <tr>
                                    <td class="post-title-cell">
                                        <a href="<?php echo cms_path('post.php'); ?>?slug=<?php echo $security->escapeURL(
                                            $post["slug"]); ?>" target="_blank">
