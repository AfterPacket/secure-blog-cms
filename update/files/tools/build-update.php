...
$excludePrefixes = ["data/", ".git/", "update/"];

$excludeExact = ["includes/config.php"];
...
function rrmdir($dir)
{
    ...
    // Release handles explicitly for Windows
    unset($items);
...
$manifest = [
    ...
    "released" => date("Y-m-d"),
    "base" =>
        "https://raw.githubusercontent.com/AfterPacket/secure-blog-cms/main/update/files",
    "files" => [],
];
