...
<head>
    ...
    <?php if ($post): ?>
        ...
        <title><?php echo $security->escapeHTML(
            $post["title"],
        ); ?> - <?php echo $security->escapeHTML(SITE_NAME); ?></title>
    <?php else: ?>
        ...
        <div class="container" style="position: relative;">
            ...
            <?php if ($security->isAuthenticated()): ?>
                <a href="<?php echo cms_path(
                    "admin/admin.php",
                ); ?>" class="admin-link">🔑 Admin Panel</a>
            <?php endif; ?>
        </div>
    </header>
    ...
    <div class="container">
        <?php if ($post): ?>
          ...
          !$security->isAuthenticated()
							...
							<div class="form-group">
								<div class="h-captcha" data-sitekey="<?php echo $security->escapeHTML(
            HCAPTCHA_SITEKEY,
        ); ?>"></div>
							</div>
						<?php endif; ?>
